...
..  description:: This is a general introduction to Discrete Mathematics

.. _the_way_of_the_proof:

The Way of the Proof
======================

The primary goal of this book is to teach you to think like a mathematician.
...
was *terrible* at that."  And since I'm a slightly awkward geek,
...
they feel that they have been *told*, rudely, that they are not
*good enough* for math and science.  They want to work hard in my
...
guess?  Don't click on the "Check Me" link below until you are
satisfied that you have an answer.
...
.. mchoicemf:: question_1
   ...
   :answer_d: 3/3
   :correct: b
   :feedback_a: There are three doors.  How many of them have a prize?
   :feedback_b: There are three doors.  How many of them have a prize?
   :feedback_c: There are three doors.  How many of them have a prize?
   :feedback_d: There are three doors.  How many of them have a prize?
...
a row (though still pretty unlikely) -- but it is only when you try it
...
because I've found that it mostly doesn't help people to *hear*
...
people's reactions to it, tells us about Mathematics.
 ...
 1. When you do math, you will be WRONG most of the time.
 ...
 2. When you try to figure something out, it is often best
  ...
  just teach me the *right* way to do it and be done with it,
 ...
 3. Don't memorize too much.  But do memorize some
 ...
 4. Develop a process that can help you attack new problems
